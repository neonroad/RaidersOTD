...
if(ds_list_size(other.inventory) < other.inventory_limit && (itemEnum == ITEMS.WEAPON_PISTOL || itemEnum == ITEMS.WEAPON_SHOTGUN || itemEnum == ITEMS.WEAPON_RIFLE || itemEnum == ITEMS.WEAPON_SNIPER || itemEnum == ITEMS.WEAPON_NADE || itemEnum == ITEMS.WEAPON_SHOVEL)){
